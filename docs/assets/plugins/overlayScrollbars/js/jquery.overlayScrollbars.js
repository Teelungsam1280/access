    ...
    function(window, document, undefined, framework) {
        ...
        var PLUGIN = (function() {
            ...
            function initOverlayScrollbarsStatics() {
                if(!_srcGlobals)
                    _srcGlobals = new OverlayScrollbarsGlobals(_srcOptions._defaults);
                if(!_srcAutoUpdateLoop)
                    _srcAutoUpdateLoop = new OverlayScrollbarsAutoUpdateLoop(_srcGlobals);
            }
            ...
            function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
                ...
                *  }
                ...
                function setOptions(newOptions) {
                    var validatedOpts = _srcOptions._validate(newOptions, _srcOptions._template, true, _currentOptions)
                ...
                if(pluginTargetElements[LEXICON.l] > 0) {
                    if(optsIsPlainObj) {
                        FRAMEWORK.each(pluginTargetElements, function (i, v) {
                            inst = v;
                            if(inst !== undefined)
                                arr.push(OverlayScrollbarsInstance(inst, options, extensions, _srcGlobals, _srcAutoUpdateLoop));
                        });
                    }
                    else {
                        FRAMEWORK.each(pluginTargetElements, function(i, v) {
            ...
            _plugin.globals = function () {
                initOverlayScrollbarsStatics();
                var globals = FRAMEWORK.extend(true, { }, _srcGlobals);
                delete globals['msie'];
                return globals;
            };
            ...
            _plugin.defaultOptions = function(newDefaultOptions) {
                initOverlayScrollbarsStatics();
                var currDefaultOptions = _srcGlobals.defaultOptions;
                if(newDefaultOptions === undefined)
                    return FRAMEWORK.extend(true, { }, currDefaultOptions);

                //set the new default options
                _srcGlobals.defaultOptions = FRAMEWORK.extend(true, { }, currDefaultOptions , _srcOptions._validate(newDefaultOptions, _srcOptions._template, true, currDefaultOptions)._default);
            };
            ...
            _plugin.extension = function(extensionName, extension, defaultOptions) {
                ...
                if(argLen < 1 || !extNameTypeString) {
                    ...
                    return FRAMEWORK.extend(true, { length : _srcExtensions[LEXICON.l] }, _srcExtensions);
                }
                    ...
                    if(COMPATIBILITY.type(extension) == TYPES.f) {
                        ...
                        for(; i < _srcExtensions[LEXICON.l]; i++) {
                            if (_srcExtensions[i].name === extensionName) {
                                if(argLen > 1)
                                    _srcExtensions.splice(i, 1); //remove extension
                                else
                                    return FRAMEWORK.extend(true, { }, _srcExtensions[i]); //return extension with the given name
                            }
                        }
                    }
                }
