...
(function (global, factory) {
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                var isInvalid = false;
                if (hit) {
                    dragSelection = joinHitsIntoSelection(_this.hitDragging.initialHit, hit, calendar.srcystem.hooks.dateSelectionTransformers);
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                if (hit) {
                    ...
                    if (initialCalendar === receivingCalendar ||
                        ...
                        mutation = computeEventMutation(initialHit, hit, receivingCalendar.srcystem.hooks.eventDragMutationMassagers);
                        if (mutation) {
                ...
                if (_this.isDragging) {
                    ...
                    if (validMutation) {
                        ...
                        if (receivingCalendar === initialCalendar_1) {
                            ...
                            var transformed = {};
                            for (var _i = 0, _b = initialCalendar_1.srcystem.hooks.eventDropTransformers; _i < _b.length; _i++) {
    ...
    var EventDragging$1 = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (hit) {
                    mutation = computeMutation(initialHit, hit, ev.subjectEl.classList.contains('fc-start-resizer'), eventInstance.range, calendar.srcystem.hooks.eventResizeJoinTransforms);
                }
                if (mutation) {
    ...
    */
    ...
    function computeEventForDateSpan(dateSpan, dragMeta, calendar) {
        ...
        for (var _i = 0, _a = calendar.srcystem.hooks.externalDefTransforms; _i < _a.length; _i++) {
            var transform = _a[_i];
